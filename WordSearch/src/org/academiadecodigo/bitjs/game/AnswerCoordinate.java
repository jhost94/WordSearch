...
public enum AnswerCoordinate {
    ANSWER_1("1", "10,6", "10,8", "horizontal",false, 15),
    ANSWER_2("2","2,1", "2,12", "horizontal",false, 10),
    ANSWER_3("3","14,2", "14,12", "horizontal",false, 25),
    ANSWER_4("4","10,10", "12,10", "vertical",false, 20),
    ANSWER_5("5","2,14", "7,14", "vertical",false, 15),
    ANSWER_6("6","3,2", "13,2", "vertical",false, 10),
    ANSWER_DEFAULT("3","default", "default", "default",true, 0);
